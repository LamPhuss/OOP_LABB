...
public class Store {
    ...
    private ArrayList<hust.soict.cybersec.aims.Media.Media> itemsInStore = new ArrayList<>();

    public void addMedia(hust.soict.cybersec.aims.Media.Media media) {
    ...
    public void removeMedia(hust.soict.cybersec.aims.Media.Media media) {
    ...
    public hust.soict.cybersec.aims.Media.Media searchByTitle(String title) {
        for (hust.soict.cybersec.aims.Media.Media item : itemsInStore)
